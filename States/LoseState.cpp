...
#include "LoseState.h"
#include <iostream>
LoseState::LoseState(GameEngine* UDEngine) {
...
void LoseState::InitData() {
    ...
    m_BackButton = new Button(tempCalculateX, tempCalculateY * 2, tempCalculateWidth, tempCalculateHeight, *wonFont, "Menu");
